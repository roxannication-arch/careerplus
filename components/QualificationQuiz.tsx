    ...
    <div>
      ...
      <p className="mt-4 text-base leading-7 text-muted">
        {watching
          ...
          : "Мы работаем в формате под ключ с теми, у кого уже есть право работать в США или UK. Если разрешения пока нет — поиск работы через спонсорство визы это отдельная история. Но есть два варианта, как мы можем быть полезны."}
      </p>
