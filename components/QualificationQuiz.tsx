        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-ink md:text-3xl">
              {result ? "Результат" : "Давайте проверим, подходим ли мы друг другу"}
            </h2>
            {!result ? (
              <p className="mt-3 text-sm leading-6 text-muted">
                Выберите страну и ответьте на 6 коротких вопросов. Так мы поймём, можем ли реально помочь в формате под ключ.
              </p>
            ) : null}
          </div>
          <button
  ...
  return (
    <div>
      ...
      <p className="mt-4 text-base leading-7 text-muted">
        По вашим ответам мы подходим под формат сопровождения. На бесплатной консультации разберём вашу ситуацию, рынок и покажем, что реально.
      </p>
      <a
  ...
  return (
    <div>
      <h3 className="text-3xl font-semibold text-ink">
        {watching ? "Похоже, вы пока в стадии разведки." : "Под ключ пока не подойдёт, но есть другие варианты"}
      </h3>
      <p className="mt-4 text-base leading-7 text-muted">
        {watching
          ? "Это нормально. Под ключ мы берём тех, кто готов начать поиск в ближайшие месяцы — это работа на 3–6 месяцев плотного процесса. Если пока просто смотрите, начните с разовой консультации."
          : "Мы работаем в формате под ключ с теми, у кого уже есть право работать в США или UK. Если разрешения пока нет — поиск работы через спонсорство визы это отдельная история. В этом случае можно начать с разовой консультации."}
      </p>
      <div className="mt-7 max-w-md">
        <ResultCard
          eyebrow="$100"
          title="Консультация $100"
          body="Час разбора вашей ситуации со мной лично. Что реально, что нет, куда двигаться."
          href="/consultation"
          cta="Консультация за $100"
        />
      </div>
    </div>
  );
