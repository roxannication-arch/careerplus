...
const lessons = [
  {
    ...
    duration: "10–15 мин",
    body:
      "Почему ты не привязан к локальному рынку. Реальная воронка: 300–500 откликов ради оффера. Как выбирать рынки и компании, где ваш профиль реально рассматривают."
  },
  {
    title: "Выбрать рынок",
    duration: "15–20 мин",
    body: "Куда реально есть путь для твоей профессии. Где выше спрос и что выбрать: удалёнку или релокацию."
  },
  {
